...
SCRIPTS=/userhome/yuxian/pkgs/mosesdecoder-master/scripts
#SCRIPTS=/data/nfsdata2/nlp_application/utils/moses_decoder/moses/scripts
TOKENIZER=$SCRIPTS/tokenizer/tokenizer.perl
LC=$SCRIPTS/tokenizer/lowercase.perl
CLEAN=$SCRIPTS/training/clean-corpus-n.perl
#BPEROOT=subword-nmt/subword_nmt
BPEROOT=/userhome/yuxian/pkgs/subword-nmt/subword_nmt
BPE_TOKENS=10000

#URL="https://wit3.fbk.eu/archive/2014-01/texts/de/en/de-en.tgz"
#URL="/data/nfsdata2/nlp_application/datasets/nmt/iwslt/iwslt14/de-en.tgz"
URL="/userhome/yuxian/data/nmt/iwslt/de-en.tgz"
GZ=de-en.tgz
