...
TEXT=/userhome/yuxian/data/nmt/wmt14_en_fr/en-fr-bin
MODEL=/userhome/shuhe/shuhelearn/nmt_en_fr/small/result/checkpoint_best.pt
LOG=/userhome/shuhe/shuhelearn/nmt_en_fr/small/result/test_pred_yuxian.txt
...
#python fairseq_cli/extract_features.py $TEXT \
#    --feature-dir $TEXT/${subset}-features \
#    --gen-subset $subset \
#    --path $MODEL \
...
CUDA_VISIBLE_DEVICES=1 python fairseq_cli/extract_feature_mmap.py $TEXT \
    --gen-subset $subset --feature "both" \
    --path $MODEL \
    --batch-size 32 --beam 1 --remove-bpe --score-reference --warmup
