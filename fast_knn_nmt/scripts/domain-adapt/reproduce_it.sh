...
OUT_DIR="/data/yuxian/train_logs/wmt19-quantize"
...
CUDA_VISIBLE_DEVICES=0 python gcn_nmt/custom_fairseq/train/generate.py $DATA_DIR --gen-subset $subset --quantize \
