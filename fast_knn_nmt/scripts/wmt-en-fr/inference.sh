...
OUT_DIR="/userhome/yuxian/train_logs/knn-nmt/en-fr-fairseq/"
a=0.2
k=1024
top=64
t=0.03
...
PRED=$OUT_DIR/${subset}_bleu.gen_a${a}_t${t}_k${k}_sim_metric${sim_metric}_top${top}_ngram${ngram}_nmetric${neighbor_metric}
CUDA_VISIBLE_DEVICES=5 python fast_knn_nmt/custom_fairseq/train/generate.py $DATA_DIR --gen-subset $subset  --quantize  \
    ...
    --batch-size 1 --beam 5 --remove-bpe  --num-workers 16 \
